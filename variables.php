...
$CONTRACT_HTML = '
  <h1>Contract of work</h1>
  <p>This Contract is made and entered into as of the date set forth below by and between <strong> Alice Williams </strong> (hereinafter referred to as "Developer") and <strong id="client-name-display"> [Client Name] </strong> (hereinafter referred to as "Client").</p>
